...
class Mod extends Skateboard.BaseMod
	...
	setAvatar: (imgRelativePath) ->
		...
		$('<img src="{CGI_ORIGIN}/web/taobao/design/{designId}/log.html" style="display: none;"/>'.replace('{CGI_ORIGIN}',G.CGI_ORIGIN).replace('{designId}', designId)).appendTo $('#good-wrapper')
