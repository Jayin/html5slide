...
<div class="body-inner">
	<div class="img-bg-wrapper">
		...
		<button class="img-btn like-btn" style="top: 15.6%;">like</button>
		...
		<button class="img-btn like-btn" style="top: 34.5%;">like</button>
		...
		<button class="img-btn like-btn" style="top: 53.4%;">like</button>
		...
		<button class="img-btn like-btn on" style="top: 72.4%;">like</button>
