...
<div class="body-inner">
	<div class="img-bg-wrapper">
		...
		<button data-click-tag="l1_b1_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w1-1-b1" style="top: 18.8%;">like</button>
		...
		<button data-click-tag="l1_b2_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" data-click-tag="l1_b2_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w1-1-b2" style="top: 37.8%;">like</button>
		...
		<button data-click-tag="l1_b3_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w1-1-b3" style="top: 56.8%;">like</button>
...
" style="left: 41%; top: 81.2%; width: 16%; height: 1.4%;">tour</a>
		<button data-click-tag="l1_b4_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w1-1-b4" style="top: 75.9%;">like</button>
