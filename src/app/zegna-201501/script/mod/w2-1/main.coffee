...
<div class="body-inner">
	<div class="img-bg-wrapper">
		...
		<a data-click-tag="l1_b1_jpgclick.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn img-plus-btn" href="/view/w2-1/b1" style="left: 40%; top: 10%; width: 20%; height: 4.2%;">shirt</a>
		<a data-click-tag="l1_b1_txt1click.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w2-1/b1" style="left: 3%; top: 17.4%; width: 42%; height: 1.55%;">shirt</a>
		<a data-click-tag="l1_b1_txt2click.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w2-1/b1" style="left: 3%; top: 23.9%; width: 16%; height: 1.4%;">shirt</a>
		<button data-click-tag="l1_b1_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w2-1-b1" style="top: 15.6%;">like</button>

		<a data-click-tag="l1_b2_jpgclick.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn img-plus-btn alt" href="/view/w2-1/b2" style="left: 40%; top: 28.8%; width: 20%; height: 4.2%;">jersey</a>
		<a data-click-tag="l1_b2_txt1click.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w2-1/b2" style="left: 3%; top: 36.2%; width: 51%; height: 1.55%;">jersey</a>
		<a data-click-tag="l1_b2_txt2click.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w2-1/b2" style="left: 3%; top: 42.6%; width: 16%; height: 1.4%;">jersey</a>
		<button data-click-tag="l1_b2_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" data-click-tag="l1_b2_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w2-1-b2" style="top: 34.5%;">like</button>
		...
		<button data-click-tag="l1_b4_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn alt hidden" data-like-id="w2-1-b4" style="top: 72.4%;">like</button>
