...
<div class="body-inner">
	<div class="img-bg-wrapper">
		...
		<a class="img-btn" href="/view/w2-1/b1" style="left: 40%; top: 10%; width: 20%; height: 4.2%;">shirt</a>
		<a class="img-btn" href="/view/w2-1/b1" style="left: 3%; top: 17.4%; width: 42%; height: 1.55%;">shirt</a>
		<a class="img-btn" href="/view/w2-1/b1" style="left: 3%; top: 23.9%; width: 16%; height: 1.4%;">shirt</a>
		<button class="img-btn like-btn hidden" data-like-id="w2-1-b1" style="top: 15.6%;">like</button>

		<a class="img-btn" href="/view/w2-1/b2" style="left: 40%; top: 28.8%; width: 20%; height: 4.2%;">jersey</a>
		<a class="img-btn" href="/view/w2-1/b2" style="left: 3%; top: 36.2%; width: 51%; height: 1.55%;">jersey</a>
		<a class="img-btn" href="/view/w2-1/b2" style="left: 3%; top: 42.6%; width: 16%; height: 1.4%;">jersey</a>
		<button class="img-btn like-btn hidden" data-like-id="w2-1-b2" style="top: 34.5%;">like</button>
