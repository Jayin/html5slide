...
class Mod extends Skateboard.BaseMod
	...
	init: ->
		setTimeout ->
			Skateboard.core.load 'view/w4-1/b1'
		, 2000
...
<div class="body-inner">
	<div class="img-bg-wrapper">
		<img class="img-bg-img" src="<%=G.CDN_BASE%>/app/zegna-201501/image/w4-1-bg.jpg" />
		...
		<a data-click-tag="l1_b1_jpgclick.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w4-1/b1" style="left: 5%; top: 11%; width: 91%; height: 11.2%;">shirt</a>
		<div data-click-tag="l1_b1_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w4-1-b1" style="top: 11.3%;">
			<div class="like"></div>
		</div>

		<a data-click-tag="l1_b2_jpgclick.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w4-1/b1" style="left: 5%; top: 24%; width: 91%; height: 13.2%;">jersey</a>
		<div data-click-tag="l1_b2_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" data-click-tag="l1_b2_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w4-1-b2" style="top: 23.5%;">
			<div class="like"></div>
		</div>

		<a data-click-tag="l1_b3_jpgclick.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w4-1/b1" style="left: 5%; top: 38%; width: 91%; height: 22.2%;">shoes</a>
		<div data-click-tag="l1_b3_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w4-1-b3" style="top: 38.4%;">
			<div class="like"></div>
		</div>
		...
		<div data-click-tag="l1_b4_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w4-1-b4" style="top: 60.4%;">
			<div class="like"></div>
		</div>
