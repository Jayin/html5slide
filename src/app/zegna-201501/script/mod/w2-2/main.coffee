...
<div class="body-inner">
	<div class="img-bg-wrapper">
		...
		<a data-click-tag="l1_b1_jpgclick.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w2-2/b1" style="left: 40%; top: 10%; width: 20%; height: 4.2%;">shirt</a>
		...
		<a data-click-tag="l1_b2_jpgclick.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn" href="/view/w2-2/b2" style="left: 40%; top: 28.8%; width: 20%; height: 4.2%;">jersey</a>
		...
		<button data-click-tag="l1_b4_jpglike.<%=G.getStatCid()%>.<%=G.getStatMid()%>" class="img-btn like-btn hidden" data-like-id="w2-2-b4" style="top: 72.4%;">like</button>
